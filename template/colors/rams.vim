...
" License:      MIT
" Last Updated: Wed 18 Aug 2021 09:20:03 PM -03
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    let g:terminal_ansi_colors = ['#141414', '#8c8c8c', '#79cce5', '#8c8c8c', '#8c8c8c', '#8c8c8c', '#8c8c8c', '#8c8c8c', '#141414', '#8c8c8c', '#79cce5', '#8c8c8c', '#8c8c8c', '#8c8c8c', '#8c8c8c', '#8c8c8c']
    if has('nvim')
      let g:terminal_color_0 = '#141414'
      let g:terminal_color_1 = '#8c8c8c'
      let g:terminal_color_2 = '#79cce5'
      ...
      let g:terminal_color_10 = '#79cce5'
    ...
    hi DiffText guifg=#79cce5 guibg=#141414 gui=bold cterm=bold
    hi Directory guifg=#ebebeb guibg=#141414 gui=NONE cterm=NONE
    hi EndOfBuffer guifg=#ebebeb guibg=NONE gui=NONE cterm=NONE
    ...
    hi IncSearch guifg=#141414 guibg=#79cce5 gui=bold cterm=bold
    hi LineNr guifg=#ebebeb guibg=#141414 gui=NONE cterm=NONE
    hi MatchParen guifg=#141414 guibg=#79cce5 gui=bold,reverse cterm=bold,reverse
    ...
    hi Search guifg=#141414 guibg=#79cce5 gui=bold cterm=bold
    hi SignColumn guifg=#ebebeb guibg=#141414 gui=NONE cterm=NONE
    hi SpecialKey guifg=#ebebeb guibg=#141414 gui=NONE cterm=NONE
    hi SpellBad guifg=#79cce5 guibg=#141414 gui=underline cterm=underline
    ...
    hi Substitute guifg=#79cce5 guibg=#141414 gui=bold,reverse cterm=bold,reverse
    ...
    hi Constant guifg=#79cce5 guibg=NONE gui=NONE cterm=NONE
    ...
    hi Todo guifg=#79cce5 guibg=NONE gui=bold,underline cterm=bold,underline
    ...
    hi ALEError guifg=#79cce5 guibg=NONE gui=NONE cterm=NONE
    hi ALEWarning guifg=#79cce5 guibg=NONE gui=NONE cterm=NONE
    hi ALEInfo guifg=#79cce5 guibg=NONE gui=NONE cterm=NONE
    hi ALEErrorSign guifg=#79cce5 guibg=NONE gui=NONE cterm=NONE
    hi ALEWarningSign guifg=#79cce5 guibg=NONE gui=NONE cterm=NONE
    hi ALEInfoSign guifg=#79cce5 guibg=NONE gui=NONE cterm=NONE
    ...
    hi LspDiagnosticsDefaultWarning guifg=#79cce5 guibg=NONE gui=NONE cterm=NONE
    hi LspDiagnosticsDefaultError guifg=#79cce5 guibg=NONE gui=NONE cterm=NONE
    if !s:italics
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi DiffText ctermfg=81 ctermbg=233 cterm=bold
    ...
    hi IncSearch ctermfg=233 ctermbg=81 cterm=bold
    hi LineNr ctermfg=255 ctermbg=233 cterm=NONE
    hi MatchParen ctermfg=233 ctermbg=81 cterm=bold,reverse
    ...
    hi Substitute ctermfg=81 ctermbg=233 cterm=bold,reverse
    ...
    hi Todo ctermfg=81 ctermbg=NONE cterm=bold,underline
    ...
    hi ALEError ctermfg=81 ctermbg=NONE cterm=NONE
    hi ALEWarning ctermfg=81 ctermbg=NONE cterm=NONE
    hi ALEInfo ctermfg=81 ctermbg=NONE cterm=NONE
    hi ALEErrorSign ctermfg=81 ctermbg=NONE cterm=NONE
    hi ALEWarningSign ctermfg=81 ctermbg=NONE cterm=NONE
    hi ALEInfoSign ctermfg=81 ctermbg=NONE cterm=NONE
    hi! link diffAdded DiffAdd
    hi! link diffRemoved DiffDelete
    hi! link ExtraWhitespace SpellBad
    hi! link gitcommitOverflow SpellBad
    ...
    hi LspDiagnosticsDefaultWarning ctermfg=81 ctermbg=NONE cterm=NONE
    hi LspDiagnosticsDefaultError ctermfg=81 ctermbg=NONE cterm=NONE
    if !s:italics
...
" Color: accent               rgb(121, 204, 229)     ~        none
